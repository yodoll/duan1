                    ...
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner border">
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="view/img/ao1.jpg" alt="Image" />
                            </div>
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="view/img/ao2.webp" alt="Image" />
                            </div>
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="view/img/ao3.webp" alt="Image" />
                            </div>
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="view/img/ao4.jpg" alt="Image" />
                            </div>
                        </div>
